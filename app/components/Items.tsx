...
const Items: React.FC<ItemsProps> = ({ userId, expenses, onUpdate, onDelete }) => {
  ...
  <>
    <div className="rounded-lg bg-gray-700 shadow-lg">
      <div className="flex flex-row">
        <h2 className="p-4 px-5 rounded-t-lg text-2xl text-white w-5/6">Transactions</h2>
        <div className="pr-5 flex flex-col justify-center items-end w-1/6">
        ...
        <div className="w-full overflow-x-auto">
          ...
          <div className="w-full flex flex-row gap-1">
            <div className="py-3 flex flex-row gap-1 w-5/6">
              <p className="w-2/6 px-3 py-1 bg-gray-600 text-white rounded-md font-light">Name</p>
              <p className="w-1/6 px-3 py-1 bg-gray-600 text-white rounded-md font-light">Category</p>
              <p className="w-1/6 px-3 py-1 bg-gray-600 text-white rounded-md font-light">Amount</p>
              <p className="w-2/6 px-3 py-1 bg-gray-600 text-white rounded-md font-light">Date</p>
            </div>
            <div className="py-3 flex flex-row gap-1 w-1/6">
              <p className="w-full px-3 py-1 bg-gray-600 text-white rounded-md font-light">Options</p>
            </div>
          </div>
          {expenses.length === 0 ? (
          ...
          <div className="overflow-auto max-h-80">
              ...
              return (
                <li key={exp._id}>
                  ...
                  <div className="pl-3 bg-gray-50 text-gray-500 text-sm font-thin border-b border-b-gray-400">
