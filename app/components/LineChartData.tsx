...
export function balanceData ( expenses : Expense[]) {
    ...
    return {
        ...
        {
            label: "Balance",
            data: (Object.entries(sevenDaysBalance).map(([date, { balance }]) => {
...
export function expenseData ( expenses : Expense[]) {
    ...
    return {
        ...
        {
            label: "Income",
            data: (Object.entries(sevenDaysExpense).map(([date, { income }]) => {
              return income;
            })),
            borderColor: "#16a34a",
            // backgroundColor: "rgba(37, 99, 235, 0.2)",
        ...
        {
            label: "Expense",
            data: (Object.entries(sevenDaysExpense).map(([date, { expense }]) => {
              return expense;
            })).slice(-7),
            borderColor: "#dc2626",
            // backgroundColor: "rgba(37, 99, 235, 0.2)",
